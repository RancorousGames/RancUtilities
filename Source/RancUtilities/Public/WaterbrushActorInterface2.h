...
//#endif
//#include "WaterBrushActorInterface2.generated.h"
//
...
//
///** Dummy class needed to support Cast<IWaterBrushActorInterface2>(Object). */
//UINTERFACE()
//class RANCUTILITIES_API UWaterBrushActorInterface2 : public UInterface
//{
...
// */
//class RANCUTILITIES_API IWaterBrushActorInterface2
//{
...
//	{
//		FWaterBrushActorChangedEventParams(IWaterBrushActorInterface2* InWaterBrushActor, const FPropertyChangedEvent& InPropertyChangedEvent = FPropertyChangedEvent(/*InProperty = */nullptr))
//			: WaterBrushActor(InWaterBrushActor)
//			, PropertyChangedEvent(InPropertyChangedEvent)
//		{}
//
//		/** The water brush actor that has changed */
//		IWaterBrushActorInterface2* WaterBrushActor = nullptr;
//
...
//	 */
//	DECLARE_EVENT_OneParam(IWaterBrushActorInterface2, FWaterBrushActorChangedEvent, const FWaterBrushActorChangedEventParams&);
